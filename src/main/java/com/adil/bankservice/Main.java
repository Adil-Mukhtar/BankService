...
public class Main {
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            ...
            // Spawn 10 threads, each does 1000 random transfers between random accounts
            // (random amounts 1-50)
            ...
            if (option2 == 1) {
                ...
                try {
                    ...
                    System.out.println(
                            "Caught expected exception for non-existing account withdrawal: " + e.getMessage());
                }
            } else if (option2 == 3) {
                try {
        ...
        // deposits or withdrawals (random amounts 1-10) on random accounts. Track
